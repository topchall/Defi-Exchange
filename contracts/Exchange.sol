...
contract Exchange is ERC20 {
    ...
    function addLiquidity(uint _amount) public payable returns (uint) {
        ...
        if(cryptoDevTokenReserve == 0) {
            ...
            */
            ...
            require(_amount >= cryptoDevTokenAmount, "The amount of tokens sent is less than the minimum required tokens");
    ...
    function removeLiquidity(uint _amount) public returns (uint, uint) {
        require(_amount > 0, "the amount of tokens to withdraw must be greater than 0");
    ...
    function getAmountOfTokens(
        ...
        require(inputReserve > 0 && outputReserve > 0, "Invalid reservations. Values must be greater than 0");
    ...
    function ethToCryptoDevToken(uint _minTokens) public payable {
        ...
        */
        ...
        require(tokensBought >= _minTokens, "Insufficient withdrawal amount");
    ...
    function cryptoDevTokenToEth(uint _tokensSold, uint _minEth) public {
        ...
        require(ethBought >= _minEth, "Insufficient withdrawal amount");
